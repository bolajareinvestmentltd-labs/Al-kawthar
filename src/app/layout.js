...
export const metadata = {
  title: 'Al-Kawthar',
  description: 'A calm, premium Quranic study and reflection experience for daily worship.',
      ...
      <body className="bg-brand-surface antialiased selection:bg-brand-accent selection:text-white">
        <AudioProvider>
          <div className="w-full h-full min-h-[100dvh] max-w-md mx-auto bg-brand-surface relative shadow-2xl overflow-x-hidden flex flex-col">
            ...
            <footer className="w-full py-10 flex flex-col items-center justify-center opacity-85 border-t border-brand-primary/10 mt-auto pb-32">
